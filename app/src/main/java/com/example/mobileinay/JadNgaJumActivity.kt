...
import com.example.mobileinay.databinding.ActivityJadNgaJumBinding

class JadNgaJumActivity : AppCompatActivity() {
    private lateinit var binding: ActivityJadNgaJumBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityJadNgaJumBinding.inflate(layoutInflater)
...
//             Replace the current fragment with a new fragment
        ...
        binding.tvSenin.setOnClickListener{
            startActivity(Intent(   this@JadNgaJumActivity, JadwalNgajiActivity::class.java))
        }
