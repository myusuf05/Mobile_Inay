...
import com.example.mobileinay.databinding.ActivityJadNgaRabuBinding

class JadNgaRabuActivity : AppCompatActivity() {
    private lateinit var binding: ActivityJadNgaRabuBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityJadNgaRabuBinding.inflate(layoutInflater)
