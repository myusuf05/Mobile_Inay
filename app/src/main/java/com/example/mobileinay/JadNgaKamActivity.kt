...
import com.example.mobileinay.databinding.ActivityJadNgaKamBinding

class JadNgaKamActivity : AppCompatActivity() {
    private lateinit var binding: ActivityJadNgaKamBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityJadNgaKamBinding.inflate(layoutInflater)
