...
import com.example.mobileinay.databinding.ActivityJadNgaSelasaBinding

class JadNgaSelasaActivity : AppCompatActivity() {
    private lateinit var binding: ActivityJadNgaSelasaBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityJadNgaSelasaBinding.inflate(layoutInflater)
